...
actor = Actor.create!({first_name: "Morgan", last_name: "Freeman", known_for: "The Shawshank Redemption", gender: "Male", age: 84, image: "https://cdn.cnn.com/cnnnext/dam/assets/180523162106-01-morgan-freeman-lead-image-super-169.jpg"})

actor = Actor.create!({first_name: "Marlon", last_name: "Brando", known_for: "The Godfather", gender: "Male", age: 80, image: "https://media.gq-magazine.co.uk/photos/5e85f607013fff000829dd43/4:3/w_1440,h_1080,c_limit/20200402-brando-08.jpg"})

actor = Actor.create!({first_name: "Heath", last_name: "Ledger", known_for: "The Dark Knight", gender: "Male", age: 29, image: "https://s.abcnews.com/images/Entertainment/gty-heath-ledger-hb-170411_4x3_992.jpg"})

actor = Actor.create!({first_name: "Henry", last_name: "Fonda", known_for: "12 Angry Men", gender: "Male", age: 77, image: "https://cdn.britannica.com/48/194748-050-98A6C24B/Henry-Fonda-12-Angry-Men-Sidney-Lumet.jpg"})

actor = Actor.create!({first_name: "Liam", last_name: "Neeson", known_for: "Schindler's List", gender: "Male", age: 69, image: "https://static.independent.co.uk/s3fs-public/thumbnails/image/2019/02/04/08/liam-neeson.jpg?width=1200&auto=webp&quality=75"})

actor = Actor.create!({first_name: "Elijah", last_name: "Wood", known_for: "The Lord of the Rings", gender: "Male", age: 40, image: "https://static.independent.co.uk/2021/08/14/11/newFile.jpg?width=640&auto=webp&quality=75"})

actor = Actor.create!({first_name: "John", last_name: "Travolta", known_for: "Pulp Fiction", gender: "Male", age: 67, image: "https://www.biography.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1200/MTgwMDE3ODc1NzI4MjEzMzM2/gettyimages-498386018.jpg"})

actor = Actor.create!({first_name: "Clint", last_name: "Eastwood", known_for: "The Good, The Bad, and the Ugly", gender: "Male", age: 91, image: "https://decider.com/wp-content/uploads/2015/06/clint-eastwood-cant-act.png"})

actor = Actor.create!({first_name: "Brad", last_name: "Pitt", known_for: "Fight Club", gender: "Male", age: 57, image: "https://www.biography.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cq_auto:good%2Cw_1200/MTY3MDUxMjkzMjI1OTIwMTcz/brad-pitt-attends-the-premiere-of-20th-century-foxs--square.jpg"})

actor = Actor.create!({first_name: "Tom", last_name: "Hanks", known_for: "Forest Gump", gender: "Male", age: 65, image: "https://m.media-amazon.com/images/M/MV5BMTQ2MjMwNDA3Nl5BMl5BanBnXkFtZTcwMTA2NDY3NQ@@._V1_.jpg"})
